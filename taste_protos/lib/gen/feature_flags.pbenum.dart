...
class FeatureFlag extends $pb.ProtobufEnum {
  static const FeatureFlag FEATURE_FLAG_UNDEFINED = FeatureFlag._(0, 'FEATURE_FLAG_UNDEFINED');
  static const FeatureFlag daily_tasty = FeatureFlag._(1, 'daily_tasty');
